const movies=[
    {
        ...
        star: 5,
        duration: "02:32:22",
        discription: "The film revolves around a fantasy frame based on the novel written by the British writer (JK Rolling) (Harry Potter and the Professor's Stone), then the events revolve around the young (Harry Potter) who is celebrating his eleventh birthday, and he accidentally discovers that he is a magician and then goes to school ( Hogwarts) to learn there sorcery and sorcery.",
        id:1
    ...
    },
    {
        ...
        star: 5,
        duration: "02:33:32",
        discription: "In the sixth part of the GK series. Rolling, Harry Potter returns to his Hogwarts school to meet again with his friends Ron, Hermione, and his teacher Dumbledore. Harry discovers a book at school that was owned by his Prince Hybrid filled with strange talismans, that causes Harry to find the truth of the book’s personality. At the same time, Professor Dumbledore makes a great effort with Harry to prepare him for the confirmed battle between him and Lord Voldemort, but Harry's mind is busy with his friend's sister Ron, when he finds that he falls in love with her and feels jealous when accompanying their friend Dean",
        id:5
    }
